...
@Component({
  selector: "app-signature-obs",
  templateUrl: "./signature.component.html",
  styleUrls: ["./signature.component.scss"],
})
export class SignatureObsComponent implements AfterViewInit {
  ...
  selectTipo: any = "Firma conformidad";
  nombre: any ='';
  ...
  handleChange(e: any) {
    ...
    this.selectTipo = "Firma conformidad";
  }
