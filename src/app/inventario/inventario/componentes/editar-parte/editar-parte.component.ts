...
@Component({
  ...
  styleUrls: ['./editar-parte.component.scss'],
})
export class EditarParteComponent  implements OnInit {
  @Input("idParte") idParte: any;
  @Input("data") data: any;
  ...
  async ngOnInit() {
    ...
    this.ionicForm = this.formBuilder.group({
      ...
      noParte: [this.data.noParte, [Validators.required]],
  ...
  async submitForm() {
    ...
    this._inventario.patchParte(this.ionicForm.value,this.idParte).subscribe({
      next: (data: any) => {
        loading.dismiss();
